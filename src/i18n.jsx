...
const translations = {
  en: {
    ...
    resources: "Resources",
    resourcesBack: "Back",
    resourcesSearchPlaceholder: "Search blueprints by title...",
    resourcesSearchAriaLabel: "Search blueprints by title",
    resourcesClearSearchAriaLabel: "Clear search",
    resourcesFilterAll: "All",
    resourcesFilterEcommerce: "E-commerce",
    resourcesFilterWebsite: "Website",
    resourcesFilterGame: "Game",
    resourcesFilterProductivity: "Productivity",
    resourcesFilterDataAnalysis: "Data Analysis",
    resourcesFilterAI: "AI",
    resourcesFilterLatest: "Latest",
    resourcesLoading: "Loading blueprints...",
    resourcesTryAgain: "Try again",
    resourcesNoSearchResults: "No blueprints found for your search.",
    resourcesNoCompleted: "No completed blueprints found.",
    resourcesProjectType: "Project type",
    resourcesComplexity: "Complexity",
    resourcesCreated: "Created",
    resourcesUseIdea: "Use this idea",
    resourcesUntitled: "Untitled Blueprint",
    resourcesUnknown: "Unknown",
    resourcesUnknownDate: "Unknown date",
    resourcesErrorMessage: "Failed to load blueprints. Please try again.",
    ...
    blueprintCreateTitle: "Create your Blueprint",
    blueprintCreateSubtitle:
      "Share your idea and fine-tune the details before generating your plan.",
    blueprintProjectIdeaLabel: "Project idea",
    blueprintProjectIdeaPlaceholder: "Describe your idea...",
    blueprintProjectTypeLabel: "Project type",
    blueprintProjectTypeWeb: "Web Application",
    blueprintProjectTypeMobile: "Mobile Application",
    blueprintProjectTypeApi: "API",
    blueprintComplexityLabel: "Complexity",
    blueprintComplexitySimple: "Simple",
    blueprintComplexityMedium: "Medium",
    blueprintComplexityComplex: "Complex",
    blueprintOutputLanguageLabel: "Output language",
    blueprintOutputLanguageEnglish: "English",
    blueprintOutputLanguageArabic: "Arabic",
    blueprintCreating: "Creating...",
    blueprintCreateButton: "Create Blueprint",
    blueprintErrorEmptyIdea: "Please enter your idea.",
    blueprintErrorIdeaShort:
      "Please describe your idea in at least 20 characters.",
    blueprintErrorGeneric: "Something went wrong. Please try again.",
    blueprintMyProjectsTitle: "My Projects",
    blueprintNoProjectsTitle: "No projects yet",
    blueprintNoProjectsText: "Create a new chat to start your first project.",
    blueprintMessageSingular: "message",
    blueprintMessagePlural: "messages",
    blueprintGenerating: "Generating",
    blueprintAgentFallback: "AI Agent",
    blueprintAgentAlex: "Alex",
    blueprintAgentEmma: "Emma",
    blueprintAgentNoah: "Noah",
    blueprintAgentLuna: "Luna",
    blueprintAgentDavid: "David",
    blueprintAgentMia: "Mia",
    blueprintAgentLeo: "Leo",
    blueprintEditProfile: "Edit profile",
    blueprintProfileStats: "0 saves | 0 views",
    blueprintPublicProjects: "Public Projects",
    blueprintSaved: "Saved",
    blueprintOtherProjects: "Other Projects",
    blueprintAccountSettings: "Account Settings",
    blueprintAccountDescription:
      "Manage your account status and permanently delete your account.",
    blueprintAccountStatus: "Account status",
    blueprintAccountActive: "Your account is currently active.",
    blueprintAccountDeactivated: "Your account is currently deactivated.",
    blueprintDeactivateAccount: "Deactivate account",
    blueprintActivateAccount: "Activate account",
    blueprintDeleteAccount: "Delete account",
    blueprintDeleteAccountWarning:
      "Permanently delete your account and all associated data.",
    blueprintDeleting: "Deleting...",
    blueprintProfileSaving: "Saving...",
    blueprintProfileSaveChanges: "Save changes",
    blueprintProfileSuccess: "Profile updated successfully.",
    blueprintProfileError: "Failed to update profile.",
    blueprintProfileAccountActivated: "Your account has been activated.",
    blueprintProfileAccountDeactivated: "Your account has been deactivated.",
    blueprintDeleteConfirm:
      "Are you sure you want to permanently delete your account? This action cannot be undone.",
    blueprintDeleteError: "Unable to delete your account. Please try again.",
    blueprintAccountNamePlaceholder: "Enter your full name",
    blueprintCloseSettingsAriaLabel: "Close settings",
...
homeDark:  'Dark',
homeSystem:  'System',
homeConnectToolsNotice : 'home Connect Tools Notice',
emptyNoContentEdit : 'empty No Content Edit',
emptyNoContentAppViewer : 'empty No Content App Viewer',

  },
  ar: {
    emptyNoContentEdit : 'لا يوجد محتوى قابل للتعديل',
emptyNoContentAppViewer : 'عارض تطبيقات فارغ (بدون محتوى)',

    homeConnectToolsNotice : 'الصفحة الرئيسية | اتصال | أدوات | إشعار',
...
there: 'هناك',
    ...
    resources: "الموارد",
    resourcesBack: "رجوع",
    resourcesSearchPlaceholder: "ابحث عن المخططات بالعنوان...",
    resourcesSearchAriaLabel: "ابحث عن المخططات بالعنوان",
    resourcesClearSearchAriaLabel: "مسح البحث",
    resourcesFilterAll: "الكل",
    resourcesFilterEcommerce: "التجارة الإلكترونية",
    resourcesFilterWebsite: "موقع إلكتروني",
    resourcesFilterGame: "لعبة",
    resourcesFilterProductivity: "الإنتاجية",
    resourcesFilterDataAnalysis: "تحليل البيانات",
    resourcesFilterAI: "الذكاء الاصطناعي",
    resourcesFilterLatest: "الأحدث",
    resourcesLoading: "جارٍ تحميل المخططات...",
    resourcesTryAgain: "حاول مرة أخرى",
    resourcesNoSearchResults: "لا توجد مخططات تطابق بحثك.",
    resourcesNoCompleted: "لا توجد مخططات مكتملة.",
    resourcesProjectType: "نوع المشروع",
    resourcesComplexity: "درجة التعقيد",
    resourcesCreated: "تاريخ الإنشاء",
    resourcesUseIdea: "استخدم هذه الفكرة",
    resourcesUntitled: "مخطط بدون عنوان",
    resourcesUnknown: "غير معروف",
    resourcesUnknownDate: "تاريخ غير معروف",
    resourcesErrorMessage: "فشل تحميل المخططات. يرجى المحاولة مرة أخرى.",
    myProjects: "مشاريعي",
    ...
    blueprintCreateTitle: "أنشئ مخططك",
    blueprintCreateSubtitle:
      "شارك فكرتك وقم بتعديل التفاصيل قبل إنشاء الخطة.",
    blueprintProjectIdeaLabel: "فكرة المشروع",
    blueprintProjectIdeaPlaceholder: "صف فكرتك...",
    blueprintProjectTypeLabel: "نوع المشروع",
    blueprintProjectTypeWeb: "تطبيق ويب",
    blueprintProjectTypeMobile: "تطبيق جوال",
    blueprintProjectTypeApi: "واجهة برمجة التطبيقات",
    blueprintComplexityLabel: "درجة التعقيد",
    blueprintComplexitySimple: "بسيط",
    blueprintComplexityMedium: "متوسط",
    blueprintComplexityComplex: "معقد",
    blueprintOutputLanguageLabel: "لغة المخرجات",
    blueprintOutputLanguageEnglish: "الإنجليزية",
    blueprintOutputLanguageArabic: "العربية",
    blueprintCreating: "جارٍ الإنشاء...",
    blueprintCreateButton: "إنشاء مخطط",
    blueprintErrorEmptyIdea: "يرجى إدخال فكرتك.",
    blueprintErrorIdeaShort:
      "يرجى وصف فكرتك على الأقل بـ 20 حرفًا.",
    blueprintErrorGeneric: "حدث خطأ ما. يرجى المحاولة مرة أخرى.",
    blueprintMyProjectsTitle: "مشاريعي",
    blueprintNoProjectsTitle: "لا توجد مشاريع بعد",
    blueprintNoProjectsText: "أنشئ محادثة جديدة لبدء مشروعك الأول.",
    blueprintMessageSingular: "رسالة",
    blueprintMessagePlural: "رسائل",
    blueprintGenerating: "جارٍ الإنشاء",
    blueprintAgentFallback: "وكيل ذكاء اصطناعي",
    blueprintAgentAlex: "أليكس",
    blueprintAgentEmma: "إيما",
    blueprintAgentNoah: "نوح",
    blueprintAgentLuna: "لونا",
    blueprintAgentDavid: "ديفيد",
    blueprintAgentMia: "ميا",
    blueprintAgentLeo: "ليو",
    blueprintEditProfile: "تعديل الملف الشخصي",
    blueprintProfileStats: "0 محفوظات | 0 مشاهدة",
    blueprintPublicProjects: "المشاريع العامة",
    blueprintSaved: "المحفوظات",
    blueprintOtherProjects: "مشاريع أخرى",
    blueprintAccountSettings: "إعدادات الحساب",
    blueprintAccountDescription:
      "إدارة حالة حسابك وحذف الحساب نهائيًا.",
    blueprintAccountStatus: "حالة الحساب",
    blueprintAccountActive: "حسابك نشط حاليًا.",
    blueprintAccountDeactivated: "حسابك غير مفعل حاليًا.",
    blueprintDeactivateAccount: "تعطيل الحساب",
    blueprintActivateAccount: "تفعيل الحساب",
    blueprintDeleteAccount: "حذف الحساب",
    blueprintDeleteAccountWarning:
      "احذف حسابك نهائيًا وجميع البيانات المرتبطة به.",
    blueprintDeleting: "جارٍ الحذف...",
    blueprintProfileSaving: "جارٍ الحفظ...",
    blueprintProfileSaveChanges: "حفظ التغييرات",
    blueprintProfileSuccess: "تم تحديث الملف الشخصي بنجاح.",
    blueprintProfileError: "فشل تحديث الملف الشخصي.",
    blueprintProfileAccountActivated: "تم تفعيل حسابك.",
    blueprintProfileAccountDeactivated: "تم تعطيل حسابك.",
    blueprintDeleteConfirm:
      "هل أنت متأكد من حذف حسابك نهائيًا؟ لا يمكن التراجع عن هذا الإجراء.",
    blueprintDeleteError: "تعذر حذف حسابك. يرجى المحاولة مرة أخرى.",
    blueprintAccountNamePlaceholder: "أدخل اسمك الكامل",
    blueprintCloseSettingsAriaLabel: "إغلاق الإعدادات",
