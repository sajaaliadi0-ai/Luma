    ...
    <div className="workspace-page">
      <main className="workspace-main">
        ...
        <div className="workspace-filters">
          ...
          <button
            className={`workspace-filter-btn ${
              filter === "All" ? "active" : ""
            }`}
              ...
              <div className="workspace-tags">
                ...
                <span className="workspace-tag">
                  {(() => {
                    ...
                    if (ty === "Mobile App")
                      return t("typeMobileApp");

                    if (ty === "API Service")
                      return t("typeApiService");

                    if (ty === "Platform")
                      return t("typePlatform");
                ...
                <span className="workspace-tag">
                  {(() => {
                    ...
                    if (lv === "Complex")
                      return t("levelComplex");

                    if (lv === "Medium")
                      return t("levelMedium");

                    if (lv === "Simple")
                      return t("levelSimple");
