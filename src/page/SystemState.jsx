...
const SystemState = () => {
  ...
  if (loading) {
    return <div className="loading-page">{t("loadingSystemData")}</div>;
  }

  const statusIcon = (status) => {
    if (status === "Running") return <FiCheckCircle />;
