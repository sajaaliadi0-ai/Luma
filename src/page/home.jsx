import { FiChevronDown, FiMic, FiPlus, FiZap, FiX } from "react-icons/fi";
...
function Home({ themeMode, setThemeMode }) {
  ...
  const handleSend = () => {
    ...
    sessionStorage.setItem("blueprintPrompt", text);
  ...
  return (
    <div className="home-page">
      ...
      <div className="home-top-credit">
        {t("homeFreePlan")} ·<a href="#">{t("workspaceUpgrade")}</a>
      </div>

      {/* TEAM */}

      <div className="home-team-orbs" aria-label={t("homeTeamAriaLabel")}>
        {avatars.map((avatar, index) => (
          ...
          >
            {hoveredAgent === index && (
              <div className="home-agent-tooltip">{t(agents[index])}</div>
            )}
      ...
      <div className="home-prompt">
        ...
        <footer>
          ...
          <div className="home-prompt-action">
            ...
            {showPlusMenu && (
              <div className="home-plus-menu">
                <button>{t("homeUploadFile")}</button>

                <button>{t("homeAddImage")}</button>

                <button>{t("homeConnectTools")}</button>
              </div>
            )}
          </div>
          ...
          <button type="button" className="home-build-button">
            {t("homeBuild")}
          ...
          <button
            ...
            className={listening ? "home-recording" : ""}
          >
            <FiMic />
          </button>
        ...
        <aside className="home-tools-notice">
          ...
          <span>{t("homeConnectToolsNotice")}</span>

          <div className="home-tool-dots">● ● ● ●</div>
