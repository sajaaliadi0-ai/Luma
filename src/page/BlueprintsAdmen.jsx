...
const Blueprints = () => {
  ...
  const deleteBlueprint = (id) => {
    setBlueprints(blueprints.filter((item) => item.id !== id));
  };
        ...
        <div className="blueprints-page">
          ...
          <div className="stats-container">
            <div className="stat-card">
              ...
              <div>
                <span>{t("totalBlueprints")}</span>

                <h2>{blueprints.length}</h2>
              </div>
            </div>
            ...
            <div className="stat-card">
              ...
              <div>
                ...
                <h2>
                  {blueprints.filter((b) => b.status === "Building").length}
                </h2>
              </div>
            </div>
            ...
            <div className="stat-card">
              ...
              <div>
                ...
                <h2>
                  {blueprints.filter((b) => b.status === "Failed").length}
                </h2>
              </div>
            </div>
          </div>
