...
function User({ dark, setDark }) {
   ...
   *
   * IMPORTANT:
   * Replace only the endpoint below with the exact
   * Users endpoint from your API documentation.
   */
  ...
  return (
    <div className={`user-page ${dark ? "dark" : ""}`}>
      {/* ================= SIDEBAR ================= */}
      ...
      <aside className="user-sidebar">
        ...
        <nav className="user-navigation">
          <Link to="/Overview" className="user-nav-item">
            <span className="user-nav-icon">⌂</span>
            <span>Overview</span>
          </Link>

          <Link to="/" className="user-nav-item user-nav-active">
            <span className="user-nav-icon">♙</span>
            <span>Users</span>
          </Link>

          <Link to="/Blueprints" className="user-nav-item">
            <span className="user-nav-icon">▣</span>
            <span>Blueprints</span>
          </Link>

          <Link to="/Logs" className="user-nav-item">
            <span className="user-nav-icon">≡</span>
            <span>Logs</span>
          </Link>

          <Link to="/SystemStats" className="user-nav-item">
            <span className="user-nav-icon">◫</span>
            <span>System Stats</span>
          </Link>

          <Link to="/Settings" className="user-nav-item">
            <span className="user-nav-icon">⚙</span>
            <span>Settings</span>
          </Link>
        </nav>
      ...
      <main className="user-main">
        ...
        <header className="user-header">
          <div>
            <h1>Users</h1>
            <p>Manage and monitor LUMA users.</p>
          </div>
        ...
        <section className="user-content-card">
          <div className="user-content-header">
            <div>
              <h2>All Users</h2>
              <p>View registered users and their information.</p>
            </div>
        ...
        >
          ...
          >
            ...
            <div className="user-details-grid">
              ...
              <div className="user-detail-item">
                <span>Status</span>
                <strong>{getUserStatus(selectedUser)}</strong>
              </div>
